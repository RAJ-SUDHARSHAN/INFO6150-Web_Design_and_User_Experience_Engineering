    ...
    return (
        <div className="cats__cards">
            <div className="cats__card-content">
                ...
                <img className="cats__card-content-pic" src="http://placekitten.com/300/300?image=2" alt="Card1 Cat" />
            ...
            <div className="cats__card-content">
                ...
                <img className="cats__card-content-pic" src="http://placekitten.com/300/300?image=3" alt="Card2 Cat" />
            ...
            <div className="cats__card-content">
                ...
                <img className="cats__card-content-pic" src="http://placekitten.com/300/300?image=4" alt="Card3 Cat" />
            ...
            <div className="cats__card-content">
                ...
                <img className="cats__card-content-pic" src="http://placekitten.com/300/300?image=5" alt="Card4 Cat" />
