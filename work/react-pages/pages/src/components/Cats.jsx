    ...
    return (
        <div className="cats__cards">
            <div className="cats__card-content">
                ...
                <img className="cats__card-content-pic" src="http://placekitten.com/300/300?image=2" alt="Card1 Cat image" />
            ...
            <div className="cats__card-content">
                ...
                <img className="cats__card-content-pic" src="http://placekitten.com/300/300?image=3" alt="Card2 Cat image" />
            ...
            <div className="cats__card-content">
                ...
                <img className="cats__card-content-pic" src="http://placekitten.com/300/300?image=4" alt="Card3 Cat image" />
            ...
            <div className="cats__card-content">
                ...
                <img className="cats__card-content-pic" src="http://placekitten.com/300/300?image=5" alt="Card4 Cat image" />
            ...
            <div className="cats__card-content">
                ...
                <img className="cats__card-content-pic" src="http://placekitten.com/300/300?image=6" alt="Card5 Cat image" />
            ...
            <div className="cats__card-content">
                ...
                <img className="cats__card-content-pic" src="http://placekitten.com/300/300?image=7" alt="Card6 Cat image" />
